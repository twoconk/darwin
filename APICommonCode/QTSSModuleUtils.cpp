                                                        ...
                                                        StrPtrLen* inStringArg)
{
	...
	if (inStringArg != NULL && inStringArg->GetAsCString()!= NULL){
		qtss_printf("SendErrorResponse err:%s\n",inStringArg->GetAsCString() );
	}
...
IPComponentStr IPComponentStr::sLocalIPCompStr("127.0.0.1");
