#ifndef __RTSP_CLIENT_SESSION__
#define __RTSP_CLIENT_SESSION__
...
class RTSPClientSession  : public Task
{
public:
	 ...
	 RTSPClientSession(UInt32 inAddr, UInt16 inPort, char* inURL,
    ...
    private:
        ...
        RTSPClient*     RTSPClientSessionClient;
